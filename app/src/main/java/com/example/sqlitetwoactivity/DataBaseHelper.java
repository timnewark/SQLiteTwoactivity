...
//in SQLite you have to close the database after use.
    ...
    public List<CustomerModel> getEveryone2(){
        ...
        //THIS ONE ABOVE MAYBE //String queryString = "SELECT * FROM " + CUSTOMER_TABLE + " WHERE " + COLUMN_ID + " = " + arg;
        //String nameString = "timbo50-00";



        // doesnt work
        //searchNumber varSendToSetter = new searchNumber(); //SENDS NAMESTRING TO searchNumber.class
        //String returnedFromGetter = varSendToSetter.getSearchNumber(); // Set the value of the setSearchNumber variable to "user inputted value of nameString
        // doesnt work
        ...
        //String customerID = searchNumber.getSearchNumber();
        //searchNumber varSendToSetter = new searchNumber(nameString); //SENDS NAMESTRING TO searchNumber.class
        //varSendToSetter.setSearchNumber(nameString); // Set the value of the setSearchNumber variable to "user inputted value of nameString
        //String returnedFromGetter =  getSearchNumber();
        //searchNumber varSendToSetter = new searchNumber(); //SENDS NAMESTRING TO searchNumber.class

        //String returnedFromGetter =  varSendToSetter.getSearchNumber();
        Log.i("RetGet/DBH: ", returnedFromGetter);




        // String fgj =  dfhdfh.getSearchNumber();
//getting
        //Log.i("RetGet/DBH: " , returnedFromGetter2);

        //returnedFromGetter.getSearchNumber();
...
//here
        ...
        else { //failure. do not add anything to the listbreak
